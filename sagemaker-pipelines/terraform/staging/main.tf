...
module "sagemaker_pipelines" {
  ...
  input_data_s3_path        = "s3://${var.s3_bucket_name}/iris/input/"
  model_output_s3_path      = "s3://${var.s3_bucket_name}/iris/models/"
  inference_input_s3_path   = "s3://${var.s3_bucket_name}/iris/inference-input/"
  inference_output_s3_path  = "s3://${var.s3_bucket_name}/iris/inference-output/"
  ...
  processing_schedule_enabled    = var.enable_inference_schedule
